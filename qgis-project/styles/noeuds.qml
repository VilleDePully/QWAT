...
<qgis version="2.12.3-Lyon" minimumScale="0" maximumScale="501" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 attr="_pipe_node_type" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="T" label="Té"/>
      <category render="true" symbol="1" value="couple_material" label="Chg. matériau"/>
      <category render="true" symbol="2" value="couple_year" label="Chg. année"/>
      <category render="true" symbol="3" value="couple_other" label="Chg. diamètre + matériau"/>
      <category render="true" symbol="4" value="couple_diameter" label="Chg. diamètre"/>
      <category render="true" symbol="5" value="pipe_end" label="Fin"/>
    </categories>
    <symbols>
  ...
  <SingleCategoryDiagramRenderer diagramType="Pie">
    <DiagramCategory penColor="#000000" labelPlacementMethod="XHeight" penWidth="0" diagramOrientation="Up" minimumSize="0" barWidth="5" penAlpha="255" maxScaleDenominator="501" backgroundColor="#ffffff" transparency="0" width="15" scaleDependency="Area" backgroundAlpha="255" angleOffset="1440" scaleBasedVisibility="1" enabled="0" height="15" sizeType="MM" minScaleDenominator="0">
  ...
  <attributeactions>
    <actionsetting action="qgis.utils.plugins['postgres91plusauditor'].showHistory('node20130304110005126',[% $id %])" icon="" capture="0" type="1" name="History audit"/>
  </attributeactions>
  <conditionalstyles>
    <rowstyles/>
    <fieldstyles/>
